...
backup_path = r'h:\Ankush\RESUME PRO\Browser_Extension\popup\popup.html'
dest_path = r'h:\Ankush\RESUME PRO\FULL DEPLOYING CODE\Browser_Extension\popup\popup.html'

with open(backup_path, 'r', encoding='utf-8') as f:
    content = f.read()

# Remove everything from <!-- Copy Toast --> onwards
idx = content.find('<!-- Copy Toast -->')
if idx != -1:
    content = content[:idx]

jd_review_and_ip_view = """
        <!-- JD REVIEW VIEW (shown before generation on unknown job sites) -->
        <div id="jdReviewView" class="vignova-view" style="display: none;">
            <div class="vignova-jdrv-header">
                <button id="jdReviewBackBtn" class="vignova-icon-btn" title="Cancel">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                        <polyline points="15 18 9 12 15 6"></polyline>
                    </svg>
                </button>
                <div class="vignova-jdrv-job-info">
                    <div class="vignova-jdrv-job-title" id="jdReviewJobTitle">Job Title</div>
                    <div class="vignova-jdrv-job-company" id="jdReviewCompany">Company</div>
                </div>
            </div>

            <div class="vignova-jdrv-body">
                <div class="vignova-jdrv-label">
                    <span class="vignova-jdrv-dot"></span>
                    Job Description
                    <span class="vignova-jdrv-hint">Edit if anything is missing</span>
                </div>
                <textarea
                    id="jdReviewTextarea"
    ...
    <script src="../utils/localScorer.js"></script>
    <script src="../utils/interviewPrep.js"></script>
...
final_content = content + jd_review_and_ip_view
