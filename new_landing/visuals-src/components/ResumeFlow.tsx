...
const fullText = "Tailor my resume for this product design role.";
        ...
        <motion.div key="r0" variants={container} initial="hidden" animate="show" exit="exit" className="absolute z-20 inset-0 p-8 flex flex-col items-center justify-center">
          <div className="w-full max-w-2xl">
            <motion.div variants={item} className="mb-6 text-center">
              <h2 className="text-3xl font-bold text-gray-900 tracking-tight mb-2">Tailor your resume</h2>
              <p className="text-sm text-gray-500">Add a job description to create a tailored resume.</p>
            </motion.div>
            <motion.div variants={item} className="bg-white rounded-2xl border border-gray-200 p-4 flex flex-col gap-4 shadow-xl relative">
              <div className="bg-gray-50/50 rounded-xl px-4 py-4 border border-gray-100 min-h-[80px] flex items-center">
                <span className="text-gray-800 text-base font-medium border-r-2 border-violet-500 animate-[blink_1s_step-end_infinite]">{typed}</span>
              </div>
              <div className="flex justify-end">
                <div className="relative px-6 py-2.5 rounded-xl bg-violet-600 text-white text-sm font-bold shadow-lg shadow-violet-600/30 flex items-center gap-2">
        ...
        <motion.div key="r1" variants={container} initial="hidden" animate="show" exit="exit" className="absolute z-30 inset-0 flex flex-col bg-white overflow-hidden">
          ...
          <div className="h-14 border-b border-gray-200 px-4 flex items-center justify-between bg-white shrink-0">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-violet-50 text-violet-600 flex items-center justify-center"><Zap className="w-4 h-4" /></div>
              <div>
                <h3 className="text-sm font-bold text-gray-900 leading-tight">Tailored resume</h3>
                <p className="text-[10px] text-gray-500">Data Analyst - Job post</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <div className="h-8 px-4 rounded-lg bg-violet-500 hover:bg-violet-600 text-white text-xs font-bold flex items-center transition-colors cursor-pointer shadow-sm shadow-violet-500/20">Check ATS Score</div>
          ...
          <div className="flex-1 flex min-h-0">
            ...
            <div className="w-[45%] flex flex-col border-r border-gray-200 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
              <div className="flex border-b border-gray-200 bg-[#111] text-white shrink-0">
                <div className="flex-1 py-3 text-xs font-bold text-center border-b-[3px] border-violet-500">Content</div>
                <div className="flex-1 py-3 text-xs font-bold text-center text-gray-400">Templates</div>
              </div>
              <div className="p-5 space-y-5 pb-10">
                <div className="flex items-center justify-between">
                  <h4 className="text-xs font-bold text-violet-600 flex items-center gap-1.5"><Sparkles className="w-3.5 h-3.5" /> AI Generated Content</h4>
                </div>

                <h5 className="text-[10px] font-bold text-violet-600 tracking-wider">HEADER & CONTACT</h5>

                <div className="space-y-3.5">
                  <div>
                    <label className="text-[10px] font-bold text-gray-600 mb-1.5 block uppercase">Full Name</label>
                    <div className="h-9 rounded border border-gray-200 bg-gray-50/50 px-3 flex items-center text-xs font-medium text-gray-800">Alex Carter</div>
                  </div>
                  <div>
                ...
                <h5 className="text-[10px] font-bold text-violet-600 tracking-wider mt-6">SUMMARY</h5>
            ...
            <div className="flex-1 bg-gray-50 p-6 overflow-y-auto flex justify-center [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
              <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="w-full max-w-[450px] h-max bg-white shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] p-8 border border-gray-100">
                <h1 className="text-2xl font-serif font-bold text-center tracking-widest text-gray-900 mb-1.5 uppercase">Alex Carter</h1>
