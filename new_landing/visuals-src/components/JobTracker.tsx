...
import React, { useEffect, useRef } from '../runtime';
import { Sparkles } from "lucide-react";
import { DemoImage as Image } from '../runtime';
        ...
        const animateScanner = () => {
            ...
            for (let i = 0; i < 20; i++) { // Keep density high
                particles.push({
                    ...
                    color: Math.random() > 0.6 ? "#ffffff" : "#8b5cf6"
                });
            }
    ...
    useEffect(() => {
        ...
        const loop = () => {
            ...
            for (let i = 0; i < cards.length; i++) {
                ...
                let percent = (relativePos / (cardWidth * sceneScale)) * 100;
                ...
                >
                    {STREAM_DATA.map((item, idx) => (
                        ...
                        >
                            ...
                            {/* --- LAYER 1: RAW DATA --- */}
                            <div
                                className="layer-code absolute inset-0 bg-slate-50 p-5 z-20 flex flex-col border-r border-violet-200"
                            ...
                            >
                                <Image
                                    src={`assets/template-${item.id}.png`}
