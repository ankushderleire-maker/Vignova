          ...
          <div className="w-full max-w-5xl mx-auto flex gap-6">
              ...
              <div className="space-y-3">
                <div className="p-4 rounded-xl border-2 border-violet-500 bg-violet-50/30 cursor-pointer">
                  <div className="flex gap-3">
                    <div className="mt-0.5"><div className="w-4 h-4 rounded-full border-[5px] border-violet-500 bg-white"></div></div>
                    <div>
            ...
            <motion.div variants={item} className="flex-1 bg-white rounded-2xl border border-gray-200 p-6 shadow-sm flex flex-col">
              ...
              <div className="flex p-1 bg-gray-100 rounded-lg mb-4">
                <div className="flex-1 text-center py-1.5 bg-white shadow-sm rounded-md text-xs font-bold text-violet-600">Saved Resumes</div>
              ...
              <div className="mt-6 relative">
                <div className="w-full h-12 bg-[#93B1F8] text-white rounded-xl flex items-center justify-center font-bold shadow-lg shadow-violet-500/20 gap-2"><Scan className="w-5 h-5"/> Run ATS Analysis</div>
                <motion.div
          ...
          <div className="w-full max-w-[1100px] mx-auto">
            ...
            <motion.div variants={item} className="flex justify-between items-center mb-6">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-violet-50 rounded-xl flex items-center justify-center text-violet-600"><Scan className="w-6 h-6"/></div>
                <div>
            ...
            <div className="flex gap-4 h-[350px]">
              ...
              <motion.div variants={item} className="w-48 bg-white rounded-2xl border border-gray-200 p-4 shadow-sm flex flex-col h-full shrink-0">
                <div className="mb-4 px-1">
                  <motion.h3 initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.3, type: "spring" }} className="text-3xl font-extrabold text-violet-500 tracking-tighter">92.7%</motion.h3>
                  <p className="text-[10px] font-bold text-gray-900 uppercase">ATS SCORE</p>
                </div>
                <div className="space-y-1">
                  <div className="flex items-center justify-between px-2.5 py-2 bg-violet-50 text-violet-600 rounded-lg text-xs font-bold"><span className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4"/> Overview</span></div>
              ...
              <motion.div variants={item} className="w-56 bg-white rounded-2xl border border-gray-200 p-5 shadow-sm flex flex-col items-center justify-center shrink-0">
                <div className="relative w-32 h-32 flex items-center justify-center mb-4">
                  <svg className="absolute inset-0 w-full h-full -rotate-90">
                    ...
                    <motion.circle 
                      cx="64" cy="64" r="56" stroke="#8b5cf6" strokeWidth="10" fill="none" strokeDasharray="352" strokeLinecap="round"
                ...
                <p className="text-xs font-bold text-violet-500 mb-4">Excellent</p>
                <div className="w-full pt-3 border-t border-gray-100 text-center">
                  <p className="text-xs font-bold text-violet-600 flex items-center justify-center gap-1.5"><User className="w-3 h-3"/> Entry-Level</p>
              ...
              <div className="flex-1 flex gap-4 min-w-0">
                <motion.div variants={item} className="flex-1 bg-white rounded-2xl border border-gray-200 p-4 shadow-sm min-w-0 flex flex-col">
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    {[
                      {label: 'Keywords (25%)', score: '80%', w: '80%', c: 'bg-violet-500', d: 0.6},
                      {label: 'Semantics (20%)', score: '98.6%', w: '98%', c: 'bg-violet-500', d: 0.7},
                      {label: 'Sections (15%)', score: '100%', w: '100%', c: 'bg-violet-500', d: 0.8},
                      {label: 'Impact (15%)', score: '91.7%', w: '91%', c: 'bg-violet-500', d: 0.9},
                      {label: 'Format (15%)', score: '100%', w: '100%', c: 'bg-violet-500', d: 1.0},
                      {label: 'Readability (10%)', score: '91.8%', w: '91%', c: 'bg-violet-500', d: 1.1}
                    ].map(bar => (
                      <div key={bar.label}>
                        <div className="flex justify-between text-[11px] font-bold text-gray-700 mb-1.5"><span className="truncate pr-1">{bar.label}</span><span className="text-violet-600 shrink-0">{bar.score}</span></div>
