      ...
      <motion.div key="p0" variants={container} initial="hidden" animate="show" exit="exit" className="absolute z-20 inset-0 flex bg-gray-50/50">
        ...
        <div className="w-56 bg-white border-r border-gray-200 flex flex-col p-4 shrink-0">
          <div className="space-y-1">
            <div className="flex items-center gap-3 px-3 py-2.5 bg-violet-50 text-violet-600 rounded-lg font-bold text-xs relative">
              <User className="w-4 h-4" /> Personal Info
              <div className="absolute right-3 w-1.5 h-1.5 bg-violet-600 rounded-full"></div>
            </div>
            {[
              ...
              <div key={i} className="flex items-center gap-3 px-3 py-2.5 text-gray-500 hover:bg-gray-50 rounded-lg font-medium text-xs">
                ...
                {i < 3 && <div className="absolute right-7 w-1.5 h-1.5 bg-violet-600 rounded-full"></div>}
              </div>
            ))}
          </div>
          <div className="mt-auto">
            <button className="w-full py-2.5 bg-violet-600 text-white rounded-lg text-xs font-bold flex items-center justify-center gap-2 shadow-md shadow-violet-500/20"><Save className="w-4 h-4" /> SAVE PROFILE</button>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto scale-[0.95] origin-top">
            ...
            <motion.div variants={item} className="flex items-start justify-between mb-6">
              <div className="flex gap-4 items-center">
                <div className="w-12 h-12 bg-violet-50 rounded-full flex items-center justify-center text-violet-600"><User className="w-5 h-5" /></div>
                <div>
            ...
            <motion.div variants={item} className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
              <div className="grid grid-cols-2 gap-5 mb-5">
                <div>
                  ...
                  <div className="h-10 rounded-lg border border-gray-200 bg-white px-3 flex items-center text-sm font-medium text-gray-900 shadow-sm shadow-black/5 truncate">Alex Carter</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="h-10 rounded-lg border border-gray-200 bg-white px-3 flex items-center text-sm font-medium text-gray-900 shadow-sm shadow-black/5 truncate">Alex Carter - LinkedIn</div>
                </div>
                <div>
