...
const AgentUI = (() => {
        ...
        panelEl.innerHTML = `
            <div class="vignova-agent-minimal-body">
                <div class="vignova-agent-header">
                    ...
                    <span class="vignova-agent-title">Vignova Auto Fill</span>
    ...
    function updateStatus(event) {
        ...
        const statusMap = {
            ...
            ats_detected: { text: `ATS: ${event.platform}`, color: "#8b5cf6" },
            filling: { text: `Filling fields...`, color: "#8b5cf6", animate: true },
            filled: { text: `Filled ${event.success} fields`, color: "#8b5cf6" },
