        ...
        <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-black">
            ...
            <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center relative z-10 w-full">
                ...
                >
                    ...
                    {/* TEXT ANIMATION FIX */}
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white leading-[0.9]">
                        Build Your

                        {/* Container with fixed height and overflow hidden is crucial for the "Ticker" effect */}
                        <span className="block h-[1.1em] overflow-hidden my-1 relative">
                            <AnimatePresence mode="wait">
                                <motion.span
                                    ...
                                    className="block text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-500 absolute top-0 left-0 w-full"
                                >
                                    {words[textIndex]}
                                </motion.span>
                            </AnimatePresence>
                            {/* Invisible placeholder to maintain width based on longest word (optional, or use min-width) */}
                            <span className="invisible">{words[textIndex]}</span>
                        </span>
