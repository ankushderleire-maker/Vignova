...
function CheckoutContent() {
    ...
    if (success) {
        return (
            <div className="max-w-md mx-auto mt-10 p-8 bg-green-50/10 border border-green-500/20 rounded-2xl text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400">Your subscription has been upgraded.</p>
    ...
    return (
        <div className="max-w-4xl mx-auto pb-20 animate-fade-in">
            <Link href="/dashboard/billing" className="inline-flex items-center text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-white mb-8 transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6 animate-slide-in-left delay-100">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Complete your secure payment to upgrade.</p>
                    </div>

                    <div className="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl p-6 hover:border-[var(--primary)]/50 transition-colors duration-300">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Order Summary</h3>

                        <div className="flex justify-between items-center py-3 border-b border-gray-200 dark:border-white/10">
                            <div>
                                <div className="font-medium text-gray-900 dark:text-white">{plan.name} Plan</div>
                ...
                {/* Payment Options */}
                <div className="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl p-6 h-fit animate-slide-in-right delay-200 hover:border-[var(--primary)]/50 transition-colors duration-300">
                    ...
                    {/* <div className="opacity-50 pointer-events-none grayscale">
                        <div className="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg p-4 flex items-center justify-between">
                            <span className="text-gray-600 dark:text-gray-400">Credit Card (Stripe)</span>
