                ...
                <div className="space-y-10 text-gray-300 leading-relaxed">
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside space-y-2 pl-4 text-gray-400">
                            <li><span className="text-white font-medium">Account Information:</span> Name, email address, and authentication credentials when you create an account.</li>
                            <li><span className="text-white font-medium">Career Profile Data:</span> Resume content, work experience, education, skills, and career preferences you provide to generate tailored resumes.</li>
                            <li><span className="text-white font-medium">Job Application Data:</span> Job descriptions, application statuses, and tracking information you store in our platform.</li>
                            <li><span className="text-white font-medium">Usage Data:</span> Analytics such as pages visited, features used, and session duration to improve our services.</li>
                            <li><span className="text-white font-medium">Extension Data:</span> Job listing information processed by our Chrome extension for autofill and matching features.</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white mb-4">5. AI Processing</h2>
                        <p>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            <a href="mailto:hello@vignova.io" className="text-[#00ff9c] hover:underline">hello@vignova.io</a>.
                        </p>
                    </section>
