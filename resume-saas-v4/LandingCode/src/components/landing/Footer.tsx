                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8">
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <Link
                            ...
                            className="inline-flex items-center gap-2 text-gray-400 hover:text-[#00ff9c] text-sm transition-colors"
                        >
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {footerLinks.product.map((link, i) => (
                                <li key={i}>
                                    <Link href={link.href} className="text-gray-400 hover:text-[#00ff9c] text-sm transition-colors">
                                        {link.label}
                                    </Link>
                                </li>
                            ))}
