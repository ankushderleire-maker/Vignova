            ...
            <div className="max-w-4xl">
                ...
                >
                    ...
                    <button
                        ...
                        className="inline-flex items-center px-8 py-3 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-500 hover:shadow-[0_0_30px_rgba(37,99,235,0.2)] transition-all cursor-pointer"
                    >
                        Get Started Free
                ...
                <motion.div
                    ...
                    animate="visible"
                    variants={fadeUp}
                    className="mb-20 rounded-2xl overflow-hidden border border-slate-200 shadow-[0_0_60px_rgba(37,99,235,0.06)]"
                >
                    <Image
                        ...
                        >
                            ...
                            <div className="flex flex-wrap gap-2">
                                {feature.highlights.map((h, i) => (
                                    <span
                                        key={i}
                                        className="px-3 py-1 text-xs font-medium rounded-full bg-blue-50 border border-blue-100 text-blue-600"
                                    >
                                        {h}
                                    </span>
                                ))}
                            ...
                            {/* Screenshot */}
                            <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-[0_0_40px_rgba(0,0,0,0.08)] group">
                                <Image
                                    src={feature.image}
                                    alt={feature.title}
                                    width={1200}
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    variants={fadeUp}
                    className="mt-20 text-center p-10 rounded-2xl bg-gradient-to-b from-slate-50 to-white border border-slate-200"
                >
                    <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-3">Ready to upgrade your job search?</h2>
                    <p className="text-slate-500 mb-6">Start generating tailored resumes and landing more interviews today.</p>
                    <button
                        onClick={() => window.location.href = 'https://app.vignova.io/login'}
                        className="inline-flex items-center px-8 py-3 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-500 transition-all cursor-pointer"
                    >
                        Start Free
                        <ArrowRight className="w-5 h-5 ml-2" />
                    </button>
