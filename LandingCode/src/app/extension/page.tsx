    ...
    <div className="w-full h-full bg-zinc-950 rounded-3xl flex items-center justify-center p-4 sm:p-8 relative overflow-hidden ring-1 ring-white/5">
        ...
        >
            <div className="flex items-center justify-between mb-5 border-b border-white/5 pb-4">
                ...
                <motion.div 
                    className="text-blue-400 font-bold text-sm bg-blue-500/10 px-2 py-1 rounded"
                    initial={{ opacity: 0 }}
            ...
            <div className="space-y-4">
                ...
                <div className="flex gap-2">
                    <motion.div className="h-6 px-3 rounded text-xs flex items-center bg-blue-500/20 text-blue-400 border border-blue-500/30 font-medium"
        ...
        {/* scanning laser line */}
        <motion.div 
            className="absolute top-0 left-0 w-full h-[2px] bg-blue-500 shadow-[0_0_20px_#3b82f6] z-20"
...
const AutoFillVisual = () => (
    <div className="w-full h-full bg-zinc-950 rounded-3xl flex items-center justify-center p-4 sm:p-8 relative overflow-hidden ring-1 ring-white/5">
        ...
        <div className="absolute top-6 right-6 flex items-center gap-2 bg-zinc-900 border border-white/10 rounded-full px-3 py-1.5 shadow-lg z-20">
            <motion.div 
                className="w-5 h-5 bg-blue-500 rounded flex items-center justify-center shadow-[0_0_10px_rgba(59,130,246,0.2)]"
                animate={{ scale: [1, 1, 0.9, 1.2, 1, 1], boxShadow: ["0 0 10px rgba(59,130,246,0.2)", "0 0 10px rgba(59,130,246,0.2)", "0 0 10px rgba(59,130,246,0.2)", "0 0 25px rgba(59,130,246,0.8)", "0 0 10px rgba(59,130,246,0.2)", "0 0 10px rgba(59,130,246,0.2)"] }}
            ...
            <div className="space-y-5">
                <div className="space-y-2">
                    ...
                    <div className="h-10 w-full bg-zinc-950 border border-zinc-800 rounded-lg flex items-center px-3 relative overflow-hidden">
                        ...
                        />
                        <motion.div 
                            className="text-blue-400 text-sm font-medium tracking-wide whitespace-nowrap"
                        ...
                        <motion.div 
                            className="absolute left-3 w-[2px] h-5 bg-blue-500"
                            animate={{ 
                ...
                <motion.div 
                    className="h-10 w-full bg-blue-600 rounded-lg mt-4 flex items-center justify-center opacity-50 relative overflow-hidden"
                ...
                >
                    ...
                    <div className="h-2 w-16 bg-white/80 rounded z-10" />
                </motion.div>
            </div>
        </motion.div>
    ...
    <div className="w-full h-full bg-zinc-950 rounded-3xl flex flex-col items-center justify-center p-4 sm:p-8 relative overflow-hidden ring-1 ring-white/5">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(59,130,246,0.05)_0,transparent_50%)]" />
         <div className="flex items-center justify-center gap-8 w-full mt-4">
            {/* Dropzone */}
            <motion.div 
                className="w-36 h-36 border-2 border-dashed border-blue-500/30 rounded-2xl bg-blue-500/5 flex flex-col items-center justify-center gap-3 relative"
                animate={{ borderColor: ["rgba(59,130,246,0.2)", "rgba(59,130,246,0.6)", "rgba(59,130,246,0.2)"] }}
                transition={{ duration: 2, repeat: Infinity }}
            >
                <Upload className="w-8 h-8 text-blue-500/40" />
                <span className="text-xs text-blue-500/60 font-medium tracking-wider uppercase">Drop Target</span>
            ...
            <div className="relative w-28 h-36 border border-white/5 rounded-xl bg-zinc-900/50 flex items-center justify-center shadow-2xl">
                ...
                <motion.div 
                    className="absolute w-24 h-32 bg-zinc-800 border border-blue-500/50 rounded-lg shadow-[0_0_20px_rgba(59,130,246,0.15)] flex flex-col items-center justify-center gap-3 z-10"
                    animate={{ 
                        x: [0, -140, -140, 0], 
                        scale: [1, 0.8, 0.8, 1],
                        opacity: [1, 0.8, 0, 1]
...
const QuickProfileVisual = () => (
    <div className="w-full h-full bg-zinc-950 rounded-3xl flex items-center justify-center p-8 relative overflow-hidden ring-1 ring-white/5">
        ...
        {/* Center Profile */}
        <motion.div 
            className="w-24 h-24 bg-zinc-900 border-2 border-blue-500 rounded-full shadow-[0_0_40px_rgba(59,130,246,0.2)] flex items-center justify-center relative z-20"
            animate={{ y: [-10, 10, -10] }}
            transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
        >
            ...
            <motion.div 
                className="absolute w-3 h-3 bg-blue-500 rounded-full shadow-[0_0_12px_#3b82f6]"
    ...
    return (
        <PageLayout>
            <div className="w-full max-w-4xl">
                ...
                >
                    <div className="inline-flex items-center px-3 py-1 rounded-full border border-blue-200 bg-blue-50 text-blue-600 text-xs font-medium mb-6">
                    ...
                    <Link
                        href="#"
                        className="inline-flex items-center px-8 py-3 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-500 hover:shadow-[0_0_30px_rgba(37,99,235,0.2)] transition-all"
                    >
                ...
                >
                    ...
                    <div className="hidden md:block absolute top-[15%] bottom-[5%] left-1/2 -translate-x-1/2 w-full max-w-5xl pointer-events-none z-0 opacity-30">
                            ...
                            return (
                                ...
                                >
                                    <div className="text-center md:text-left">
                                        <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-3">{screenshot.label}</h2>
                                        <p className="text-slate-500 text-lg">{screenshot.description}</p>
                                    </div>
                                    <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-[0_0_60px_rgba(0,0,0,0.08)] group">
                                        <Image
                                            src={screenshot.src || ''}
                                            alt={screenshot.alt || ''}
                                            width={1200}
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="w-full md:w-5/12 space-y-6 z-10">
                                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 leading-[1.2]">
                                        {screenshot.label}
                                    </h2>
                                ...
                                <div className="w-full md:w-1/2 relative z-10">
                                    <div className={`absolute top-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-blue-500/5 blur-[100px] rounded-full pointer-events-none -z-10 ${isEven ? '-left-20' : '-right-20'}`} />

                                    <div className="relative w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)]">
                                         {screenshot.visual}
                                    </div>
                                </div>
                            </motion.div>
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    variants={fadeUp}
                    className="text-center p-10 rounded-2xl bg-gradient-to-b from-slate-50 to-white border border-slate-200"
                >
                    <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-3">Apply to jobs faster</h2>
                    <p className="text-slate-500 mb-6">Install the Vignova extension and start tailoring resumes from any job listing.</p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link
                            href="#"
                            className="inline-flex items-center justify-center px-8 py-3 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-500 transition-all"
                        >
                            <Chrome className="w-5 h-5 mr-2" />
                            Install Extension
                        </Link>
                        <button
                            ...
                            className="inline-flex items-center justify-center px-8 py-3 bg-slate-100 border border-slate-200 text-slate-700 font-bold rounded-xl hover:bg-slate-200 transition-all cursor-pointer"
                        >
                            Start Free
