        ...
        <PageLayout>
            <div className="w-full max-w-4xl mx-auto flex flex-col items-center">
                    ...
                    {steps.map((step, index) => (
                        ...
                        >
                            ...
                            <div className="space-y-3 flex flex-col items-center text-center">
                                <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-blue-50 border border-blue-100 text-blue-600 font-bold text-sm">
                ...
                >
                    ...
                    <p className="text-slate-500 mb-6">Create your master profile and generate your first tailored resume in minutes.</p>
                    <button
