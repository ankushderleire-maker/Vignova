...
export const TemplateGallery = () => {
    ...
    return (
        <section className="relative py-20 bg-white overflow-hidden flex flex-col items-center min-h-[700px]">

            {/* Header Info */}
            <div className="relative z-10 text-center mb-16 space-y-4 px-4">
                <div className="inline-flex items-center px-3 py-1 rounded-full border border-blue-600/30 bg-blue-900/10 text-blue-500 text-xs font-medium mb-4">
                    <Sparkles className="w-3 h-3 mr-2" />
                    <span>Real-time Transformation</span>
                </div>
                <h2 className="text-4xl md:text-5xl font-bold text-slate-900 tracking-tight">
                    Raw Data to <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-emerald-600">Masterpiece</span>
                </h2>
            </div>
            ...
            >
                ...
                {/* Labels */}
                <div className="absolute top-4 left-[calc(50%-140px)] text-blue-600/40 text-[10px] font-mono font-bold tracking-[0.2em] z-20 hidden md:block">

                </div>
                <div className="absolute top-4 left-[calc(50%+40px)] text-slate-900/40 text-[10px] font-mono font-bold tracking-[0.2em] z-20 hidden md:block">
                ...
                >
                    {STREAM_DATA.map((item, idx) => (
                        <div
                            key={`${item.id}-${idx}`}
                            className="relative w-[300px] h-[400px] shrink-0 rounded-xl overflow-hidden bg-white border border-slate-200 shadow-2xl"
                        >

                            {/* --- LAYER 1: CODE --- */}
                            <div
                                className="layer-code absolute inset-0 bg-slate-50 p-6 z-20 flex flex-col border-r border-blue-600/50"
                            ...
                            >
                                ...
                                <div className="mt-auto pt-4 border-t border-blue-900/30 flex justify-between items-center">
                                    <span className="text-[10px] text-blue-900 font-mono">STATUS:</span>
                            ...
                            >
                                ...
                                <div className="absolute bottom-5 left-5 right-5 z-20">
                                    <div className="text-xs font-bold text-slate-900 mb-1 uppercase tracking-wider">{item.name}</div>
