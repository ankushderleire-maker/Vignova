        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 xl:gap-16">
          ...
          <div className="w-full lg:w-[480px] xl:w-[500px] flex flex-col justify-center items-center text-center shrink-0 z-20 pointer-events-auto mt-4 lg:mt-8">
            ...
            >
              ...
              <h1 className="text-[11px] font-bold tracking-[0.18em] uppercase leading-none">
                AI Resume Tailoring That Beats the ATS
              </h1>
            </motion.div>
              ...
              <AnimatePresence mode="wait">
                {active === 'profile' && (
                  <motion.div key="text-profile" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="absolute inset-0 flex flex-col justify-center items-center w-full">
                    <h2 className="text-5xl md:text-6xl font-extrabold text-[#0A192F] tracking-tight leading-tight mb-6">
                      Master Profile, <br />
                ...
                {active === 'saved' && (
                  <motion.div key="text-saved" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="absolute inset-0 flex flex-col justify-center items-center w-full">
                    <h2 className="text-5xl md:text-6xl font-extrabold text-[#0A192F] tracking-tight leading-tight mb-6">Your Perfect <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0A192F] to-[#2563EB]">Resume Hub.</span></h2>
                ...
                {active === 'tracker' && (
                  <motion.div key="text-tracker" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="absolute inset-0 flex flex-col justify-center items-center w-full">
                    <h2 className="text-5xl md:text-6xl font-extrabold text-[#0A192F] tracking-tight leading-tight mb-6">Never Lose <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0A192F] to-[#2563EB]">Track Again.</span></h2>
                ...
                {active === 'jobs' && (
                  <motion.div key="text-jobs" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="absolute inset-0 flex flex-col justify-center items-center w-full">
                    <h2 className="text-5xl md:text-6xl font-extrabold text-[#0A192F] tracking-tight leading-tight mb-6">Find Roles that <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0A192F] to-[#2563EB]">match You.</span></h2>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ type: "spring", stiffness: 100, damping: 20, delay: 0.3 }}
              ...
              {/* Product facts — no user-count or rating claims until there is
              ...
              <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-xs font-medium text-slate-500">
                <span className="inline-flex items-center gap-1.5">
                  <Check className="w-3.5 h-3.5 text-emerald-500" /> Free tier, no credit card
                </span>
                <span className="inline-flex items-center gap-1.5">
                  <Check className="w-3.5 h-3.5 text-emerald-500" /> Built on your real experience
                </span>
                <span className="inline-flex items-center gap-1.5">
                  <Check className="w-3.5 h-3.5 text-emerald-500" /> Export to ATS-safe PDF
                </span>
              </div>
