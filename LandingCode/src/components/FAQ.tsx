...
const faqs = [
  ...
  },
  {
    ...
    a: "By automating the most tedious parts of the job search. Instead of spending 45 minutes manually tweaking your resume for every application, Vignova does it in under 5 minutes. This allows you to apply to more high-quality jobs with perfectly optimized resumes, doubling your interview rate."
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Our templates are specifically engineered to be 100% readable by modern Applicant Tracking Systems (ATS) like Greenhouse, Workday, and Lever. We avoid complex tables or graphics that confuse parsing algorithms."
  },
  {
        ...
        <div className="divide-y divide-white/10 border-y border-white/10">
          {faqs.map((faq, index) => (
            <div key={index} className="py-1">
              ...
              >
                <span className="text-base font-medium tracking-tight text-white group-hover:text-blue-400 transition-colors">{faq.q}</span>
                <div className="ml-4 flex-shrink-0 text-slate-500">
