                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        <motion.div
                            ...
                            whileHover={{ y: -5 }}
                            className="flex flex-col rounded-2xl bg-white overflow-hidden shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] border border-slate-200 transition-all duration-300 group cursor-pointer hover:shadow-blue-500/10"
                        >
