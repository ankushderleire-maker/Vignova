...
export const HowItWorks = () => {
    return (
        <section id="how-it-works" className="py-24 bg-white relative overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#3b82f6]/3 blur-[150px] rounded-full pointer-events-none" />
                            ...
                            >
                                ...
                                >
                                    <div className="max-w-xl space-y-3">
                                        <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-[#3b82f6]/10 border border-[#3b82f6]/20 text-[#3b82f6] font-bold text-sm">
                                ...
                                <motion.div
                                    variants={fadeUp}
                                    className="relative rounded-2xl overflow-hidden border border-slate-200 shadow-[0_0_60px_rgba(0,0,0,0.5)] group"
                                >
                                    <div className="absolute inset-0 bg-gradient-to-br from-[#3b82f6]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none z-10" />
                                    <Image
                                        src={step.image}
                                        alt={step.title}
                                        width={1200}
