      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <button onClick={() => window.location.href = 'https://app.vignova.io/login'} className="h-16 px-10 rounded-full bg-white text-[#0A192F] font-bold text-lg hover:bg-gray-100 transition-colors flex items-center gap-2 shadow-2xl shadow-blue-500/20">
